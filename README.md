# AdvancedSVG colorization based on stylesheet selection

This project demonstrates how to link the color of an AdvancedSVG element to the current stylesheet
